...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-pink-50 p-4">
      <Card className="w-full max-w-md border-2 border-orange-200 bg-white/90">
        ...
        <CardContent>
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            <p>登录即表示您同意我们的</p>
            <p>
              <a href="#" className="text-orange-600 hover:underline">服务条款</a> 和 
